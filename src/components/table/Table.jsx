      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell className="tableCell">Job Date</TableCell>
            <TableCell className="tableCell">Priority</TableCell>
            <TableCell className="tableCell">Information</TableCell>
